                    ...
                    <form onSubmit={onSubmit} className="space-y-6">
                        ...
                        <div className="grid gap-4">
                            <div className="grid gap-3">
                                ...
                                <Input id="name-1" name="name" type="text" onChange={(e) => setName(e.target.value)} defaultValue={user.name || ""}/>
                            </div>
                        </div>
                        <div className="grid gap-4">
                            <div className="grid gap-3">
                                <Label htmlFor="email-1">{t("email_label")}</Label>
                                <Input id="email-1" name="email" type="email" onChange={(e) => setEmail(e.target.value)} defaultValue={user.email}/>
                            </div>
                        </div>
                        <div className="grid gap-4">
                            <div className="grid gap-3">
                        ...
                        <div className="grid gap-4">
                            <div className="grid gap-3">
                                ...
                                <Select value={role} onValueChange={(value) => setRole(value as "user" | "admin")} defaultValue={user.role}>
