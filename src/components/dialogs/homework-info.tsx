...
interface HomeworkInfoProps {
    ...
    onUpdate: (vars: { homeworkId: string; title?: string; description?: string; dueDate?: Date; completed?: boolean; subjectId?: string }) => Promise<{
        id: string;
        title: string;
        ...
        try {
            ...
            if (updatedHomework) {
                setEditData({
                    ...
                    dueDate: updatedHomework.dueDate ? new Date(updatedHomework.dueDate).toISOString().split('T')[0] : "",
                    ...
                    <div className="flex items-start justify-between mb-3">
                        {isEditing ? (
                            <Select
                                ...
                                onValueChange={(value) => setEditData({ ...editData, subjectId: value })}
                            >
                                <SelectTrigger>
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            {isEditing ? (
                                ...
                                <h2 className="text-2xl font-bold flex-1 mr-4">{homework.title}</h2>
                            )}
                            ...
                            {isEditing ? (
                                ...
                                <span
                                    className="text-1xl font-bold flex-1 whitespace-nowrap text-right text-muted-foreground">
                                        {homework.dueDate ? new Date(homework.dueDate).toLocaleDateString() : t("no_due_date")}
                                    </span>
                            )}
                        </div>
                        <div className="flex items-center gap-4">
                            <div className="flex items-center gap-2">
                                ...
                                {(isEditing ? editData.completed : homework.completed)} {t("completed")}
                            </span>
                            </div>
                        </div>
                    </div>
